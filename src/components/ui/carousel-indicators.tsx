...
export default function CarouselIndicators() {
  ...
  return (
    <div className='absolute lg:top-[68%] md:top-[40%] top-[35%] z-20 left-1/2 h-[200px] w-[90vw] max-w-[1200px] transform -translate-x-1/2 flex flex-col justify-end gap-4 pointer-events-none'>
