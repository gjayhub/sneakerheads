...
export default function SpecialOffer() {
  return (
    <section className='w-screen my-20 overflow-hidden '>
      <h1 className='text-center md:text-left md:py-5 overflow-hidden max-w-[1200px] mx-auto'>
      ...
      <div className=' lg:h-[600px] h-[80vh] md:h-[65vh] z-10 relative '>
        ...
        <div className='absolute lg:h-auto lg:top-[15%] top-2 left-[10%]  grid lg:grid-cols-3 [grid-template-rows:300px_200px_300px] w-[80vw] mx-auto'>
          <div className=' flex lg:flex-col z-10 justify-center md:justify-start  items-center  lg:grid-cols-1 '>
          ...
          <div className=' lg:relative lg:grid-cols-1 flex lg:px-8 flex-col w-full lg:-bottom-0  md:w-[300px] lg:w-full lg:justify-end gap-4   absolute bottom-[35%] lg:right-[10%] md:right-0  md:bottom-[40%] '>
            <h3 className='text-2xl lg:text-5xl '>Pegasus 41 Electric</h3>
            <p className='lg:text-xl text-lg lg:mt-10 font-semibold'>
              ₱ :{" "}
            ...
            <div className='grid grid-cols-2 gap-4 '>
              <Button
                className='col-span-1 py-2 text-xs lg:text-base'
                type='primary'
              >
                BUY
              </Button>
